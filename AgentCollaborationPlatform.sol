...
contract AgentCollaborationsContract {
        ...
        public
    {
        ...
        flag = "completeTask success";
    }

    function checkFunction() public view returns (string memory) {
        if (bytes(flag).length == 0) {
            return "no function success";
        } else {
            return flag;
        }
    }
